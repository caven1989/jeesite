...
<head>
	<title>运行值班系统</title>
	<meta name="decorator" content="blank"/><c:set var="tabmode" value="${empty cookie.tabmode.value ? '1' : '1'}"/>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName">运行值班系统</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
				Copyright &copy; 运行值班系统 - Powered By 农行陕西省分行 ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
